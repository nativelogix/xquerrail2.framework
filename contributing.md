...
# Contributing to xquerrail2.framework

xquerrail2.framework welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use xquerrail2.framework, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with both MarkLogic and XQuerrail.
...
```sh
$ git clone git@github.com:username/xquerrail2.framework.git
$ cd xquerrail2.framework
$ git remote add upstream git://github.com/marklogic/xquerrail2.framework.git
```
...
Go to https://github.com/username/xquerrail2.framework and select your feature branch. Click
